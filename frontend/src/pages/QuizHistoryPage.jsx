...
const QuizHistoryPage = () => {
    ...
    if (loading)
        return <p className="loading-text">Loading your quiz history...</p>;
    ...
    return (
        <div className="quiz-history-page">
            ...
            <div className="quiz-history-container">
                ...
                {history.length === 0 && (
                    <p className="no-history-text">No quizzes attempted yet.</p>
                )}
                            ...
                            <div className="quiz-card-header">
                                <div>
                                    <p className="quiz-date">
                                        <strong>Date:</strong>{" "}
                                        {h.date?.toDate ? h.date.toDate().toLocaleString() : h.date}
                                    </p>
